...
let final = true
let factor = []
document.querySelectorAll('#DataGrid1 tr:nth-child(n + 2) > td:nth-child(5)').forEach( e => factor.push(+e.textContent))
let score = []
let total = 0
document.querySelectorAll('#DataGrid1 tr:nth-child(n + 2) > td:nth-child(6)').forEach( (e, idx) => {
	switch(e.textContent) {
		case '尚未確認':
			final = false
			score.push(3)
...
let newRow = document.createElement('tr')
newRow.innerHTML = `<td><font color="#330099">GPA</font></td><td><font color="#330099">${final?'確認':'未確認'}</font></td><td><font color="#330099">${(total/factor.reduce( (a, b) => a + b, 0)).toFixed(2)}</font></td><td><font color="#330099"></font></td><td><font color="#330099"></font></td><td><font color="#330099">&nbsp;</font></td><td><font color="#330099"></font></td>`
document.querySelectorAll('#DataGrid1')[0].appendChild(newRow)
}
